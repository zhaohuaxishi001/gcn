...
if __name__ == '__main__':
    ...
    dict = {'layout':'coco_cut','strategy':'uniform'}

    a=StreamSpatialTemporalGraph(graph_args=dict,in_channels=64)

    # graph = Graph(layout='coco_cut',strategy='uniform',max_hop=1,dilation=1)
    # A = torch.tensor(graph.A, dtype=torch.float32, requires_grad=False)
    print(a)
    # x = torch.Tensor(3,54,28,6)
    #
    #
    #
    # a.forward(x=x)
